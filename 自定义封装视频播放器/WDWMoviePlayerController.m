...
//视频播放源
//#define MoivePlayerSource @"1.mp4"
//#define MoivePlayerSourceUrl @"http://baidu.ku6.com/watch/03718307737490137306.html?page=videoMultiNeed"


@interface WDWMoviePlayerController (){
...
@implementation WDWMoviePlayerController
...
- (void)viewDidLoad {
    ...
    // 网络视频
    //_playerItem = [AVPlayerItem playerItemWithURL:[NSURL URLWithString:MoivePlayerSourceUrl]];
